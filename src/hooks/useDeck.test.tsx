...
describe('useDeck', () => {
  ...
  it('should return null title and empty words when selectedDeckId is null', async () => {
  ...
  it('should return deck title and words when selectedDeckId is not null', async () => {
