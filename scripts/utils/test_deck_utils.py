...
def test_group_by_pos():
    csv_rows = [
        {"id": "2", "part_of_speech": "pos 2", "answer": "answer 4"},
        {"id": "1", "part_of_speech": "pos 1", "answer": "answer 3"},
        {"id": "4", "part_of_speech": "pos 2", "answer": "answer 2"},
        {"id": "3", "part_of_speech": "pos 1", "answer": "answer 1"},
    ]
